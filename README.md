# 🦁 ALFABetiza - Alfabetização Divertida

> **Aprender a ler e contar nunca foi tão divertido!** 🚀

O **ALFABetiza** é um aplicativo web progressivo e gamificado, desenvolvido para auxiliar no processo de alfabetização e letramento matemático de crianças. Com uma interface colorida, amigável e interativa, o app transforma o aprendizado em um jogo envolvente.
...
*   **[Dexie.js](https://dexie.org/)** - Banco de dados local (IndexedDB) para salvar progresso.
*   **[Lucide React](https://lucide.dev/)** - Ícones bonitos e leves.
*   **[Web Speech API](https://developer.mozilla.org/en-US/docs/Web/API/Web_Speech_API)** - Síntese de voz nativa.
...
1.  **Clone o repositório:**
    ```bash
    git clone https://github.com/RenanDurval/ALFABetiza.git
    cd ALFABetiza
    ```
...
*(Adicione prints do seu projeto aqui)*
...
Desenvolvido com ❤️ por [Renan Durval](https://github.com/RenanDurval).
